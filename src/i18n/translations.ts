...
export const translations = {
  ca: {
    ...
    universities: {
      ...
      subtitle:
        "Graduats d'aquests centres ja han viscut la seva festa amb Graduacions.cat",
    },
    services: {
      eyebrow: "Els nostres serveis",
      title: "Tot el que necessites",
      subtitle:
        "Ens encarreguem de cada detall perquè només hagis de passar-ho bé.",
      items: [
        {
          title: "Sopars & Càtering",
          description:
            "Menús personalitzats per a tots els gustos amb opció de sopar i fer la festa al mateix lloc.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Fotògrafs professionals per capturar tots els moments de la nit.",
        },
        {
          title: "Aftermovie",
          description:
            "Gravem tota la nit i editem un vídeo resum professional per compartir.",
        },
        {
    ...
    contact: {
      ...
      subtitle:
        "Omple el formulari i et respondrem les teves preguntes per whatsapp en menys de 24h.",
      phoneLabel: "Telèfon",
      messageLabel: "Dubtes",
      ...
      formError:
        "Hi ha hagut un error. Prova-ho de nou o escriu-nos directament.",
      formSending: "Enviant...",
    },
    footer: {
      description:
    ...
    whatsapp: {
      ...
      message:
        "Hola!%20M%27agradaria%20informaci%C3%B3%20sobre%20festes%20de%20graduaci%C3%B3",
    },
  },
  es: {
    layout: {
    ...
    universities: {
      ...
      title:
        "Organizamos las graduaciones de los centros de estudios más reconocidos",
      subtitle:
        "Graduados de estos centros ya han vivido su fiesta con Graduacions.cat",
    },
    services: {
      eyebrow: "Nuestros servicios",
      title: "Todo lo que necesitas",
      subtitle:
        "Nos encargamos de cada detalle para que solo tengas que pasarlo bien.",
      items: [
        {
          title: "Cenas & Catering",
          description:
            "Menús personalizados para todos los gustos con opción de cenar y hacer la fiesta en el mismo lugar.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Fotógrafos profesionales para capturar todos los momentos de la noche.",
        },
        {
          title: "Aftermovie",
          description:
            "Grabamos toda la noche y editamos un vídeo resumen profesional para compartir.",
        },
        {
    ...
    contact: {
      ...
      subtitle:
        "Rellena el formulario y te responderemos por whatsapp en menos de 24h.",
      phoneLabel: "Teléfono",
      messageLabel: "Dudas",
      ...
      formError:
        "Ha habido un error. Inténtalo de nuevo o escríbenos directamente.",
      formSending: "Enviando...",
    },
    footer: {
      description:
    ...
    whatsapp: {
      ...
      message:
        "Hola!%20Me%20gustar%C3%ADa%20informaci%C3%B3n%20sobre%20fiestas%20de%20graduaci%C3%B3n",
    },
  },
} as const;

export type Translations =
  | (typeof translations)["ca"]
